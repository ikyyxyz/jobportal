    ...
    <div className="bg-[#1d4ed8]">
      ...
      >
        <div className="w-full z-10">
          <div className="mb-8">
            <p className="text-white-700 font-bold text-4xl">{title}</p>
          </div>
          ...
          <div className="w-full flex items-center justify-around bg-white px-2 md:px-5 py-2.5 md:py-6 shadow-2xl rounded-full">
            ...
            <div>
              <CustomButton
                ...
                title="Search"
                containerStyles={
                  "text-white py-2 md:py3 px-3 md:px-10 focus:outline-none bg-secondary rounded-full md:rounded-md text-sm md:text-base"
                }
              />
            </div>
          </div>
