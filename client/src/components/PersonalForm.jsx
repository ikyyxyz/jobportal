  ...
  return (
    <>
      <div className="w-full md:w-2/3 2xl:w-2/4 bg-white shadow-lg p-10 pb-10 rounded-lg">
        <div className="flex items-center justify-between border border-solid border-blue-600 py-2 px-3">
                    ...
                    >
                      ...
                      <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                        ...
                        >
                          ...
                          <TextInput
                            name="expSalary"
                            label="Expeted Salary"
                            placeholder="Rp. 3.000.000"
                            type="text"
                            register={register("expSalary", {
                              required: "Expeted Salary is required",
                            })}
                            error={
                              errors.expSalary ? errors.expSalary?.message : ""
                            }
                          />
            ...
            <div className="flex flex-col items-center justify-center mb-4 mt-3">
              ...
              <div className="mt-4">
                <a
                  ...
                  download={userInfo?.cvUrl}
                >
                  View CV
                </a>
              </div>

              <div className="w-full flex flex-wrap lg:flex-row justify-center mt-8 text-sm">
                ...
                |
                <p className="flex gap-1 items-center justify-center  px-3 py-1 text-slate-600 rounded-full">
                  <GrCurrency /> {userInfo?.expSalary ?? "No Salary"}
                </p>{" "}
                |
                <p className="flex gap-1 items-center justify-center  px-3 py-1 text-slate-600 rounded-full">
            ...
            <div className="w-full py-5">
              <div className="w-full flex flex-col-reverse md:flex-row gap-8 py-6">
                <div className="w-full md:w-2/3 flex flex-col gap-4 text-lg text-slate-600 mt-20 md:mt-0">
                  <p className="text-[#0536e7]  font-semibold text-xl">
                    About Me
                  </p>
