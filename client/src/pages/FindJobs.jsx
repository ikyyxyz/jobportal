...
const FindJobs = () => {
  ...
  return (
    <div>
      <Header
        title="Find Your Dream Job with Ease Here"
        type="home"
      ...
      <div className="container mx-auto flex gap-6 2xl:gap-10 md:px-5 py-0 md:py-6 bg-[#f7fdfd]">
        <div className="hidden md:flex flex-col w-1/6 h-fit bg-white shadow rounded py-3">
          ...
          {numPage > page && !isFetching && (
            <div className="w-full flex items-center justify-center pt-16">
              <CustomButton
                ...
                title="Load More"
                containerStyles={` py-1.5 px-5 focus:outline-none bg-yellow-400 text-white rounded-full text-base border border-yellow-400`}
              />
            </div>
          )}
        </div>
