                  ...
                  >
                    ...
                    <div className="mt-4">
                      {isLoading ? (
                        ...
                        <CustomButton
                          type="submit"
                          containerStyles="inline-flex justify-center rounded-md border border-transparent bg-yellow-500 px-8 py-2 text-sm font-medium text-white hover:bg-yellow-600 hover:text-[#fff] focus:outline-none "
                          title={"Submit"}
                        />
                      )}
                    </div>
          ...
          {user?.user?.accountType === undefined && info?._id === user?._id && (
            <div className="flex items-center justifu-center py-5 md:py-0 gap-4">
              <CustomButton
                ...
                iconRight={<FiEdit3 />}
                containerStyles={`py-1.5 px-3 md:px-5 focus:outline-none bg-yellow-400  hover:bg-yellow-500 text-white rounded text-sm md:text-base border border-yellow-400`}
              />
